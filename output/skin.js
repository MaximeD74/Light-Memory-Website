...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me._node_title.logicBlock_position = function() {
			...
			if (me._node_title.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._node_title.style.transition='right 0s, bottom 0s, width 0s, height 0s, opacity 500ms ease 0ms';
				if (me._node_title.ggCurrentLogicStatePosition == 0) {
					me._node_title.style.right='30px';
					me._node_title.style.bottom='30px';
				}
				else {
					me._node_title.style.right='40px';
					me._node_title.style.bottom='10px';
				}
			}
		}
		...
		me._menu.appendChild(me._image_2);
		...
		me._svg_1.onclick=function (e) {
			...
			me._svg_3.ggVisible = !me._svg_3.ggVisible;
			var flag=me._svg_3.ggVisible;
			me._svg_3.style.transition='none';
			me._svg_3.style.visibility=((flag)&&(Number(me._svg_3.style.opacity)>0||!me._svg_3.style.opacity))?'inherit':'hidden';
		}
		...
		me._menu_toggle_off_active.logicBlock_visible();
		me._menu_toggle_off_active.onclick=function (e) {
		...
		hs='data:image/png;base64,'+
			''+
			''+
			''+
			'EWYHX6fCxWJx0rKsATyeOOGcZVkDfpwHFJbLZzKZPUR0tA1h8zQRjfopkP4vlN0LlEqlC7quv8bM++Ahi3SBWWbel0wmd6pyHgjwl5lqtfo6HlZmvAvvv8zMAygCOJ1MJi8/8b/M2MEwDHH16tUdq6uru5tX1Nvx8KIyjEd/mmrg4dG1ycw3Q6HQZH9//42gf5rqoIMOOnim8Q9h2wW8tutfqgAAAABJRU5ErkJggg==';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		hs ='';
		hs += 'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;';
	...
	function SkinCloner_categories_cloner_Class(item, parentScope, ggParent, parameter) {
		...
		me._category_title.appendChild(me._rectangle_1);
	...
	function SkinCloner_node_cloner_Class(nodeId, parentScope, ggParent, parameter) {
		...
		me._node_cloner_title.appendChild(me._rectangle_10);
	...
	function SkinHotspotClass_ht_pdf(parentScope,hotspot) {
		...
		me._ht_pdf.onclick=function (e) {
			...
			if (
				...
				let pdfInterval_297 = setInterval(() => {
			...
			if (
				...
				let pdfInterval_298 = setInterval(() => {
